...
public class PnRTCClient {
    ...
    private String UUID;
    public String PUB_KEY = "pub-c-e8edbd5e-fac7-458c-803f-1d091922c390"; // Use Your Pub Key
    public String SUB_KEY = "sub-c-a93ce8e0-a521-11e7-88d7-aa3d3dcf7b8c"; // Use Your Sub Key
    ...
    public PnRTCClient(String pubKey, String subKey) {
        ...
        pnConfiguration.setSecretKey("sec-c-MGExN2IxYTQtYmQ5Ny00NWJiLWJlYzAtZDg1Y2Q2MzVjNTY3");
    ...
    /**
     * Return the {} peer connection constraints.
     ...
     * @return The PnRTCClient's {} instance
     */
    ...
    /**
     * Return the UUID (username) of the {}. If not
    ...
    /**
     * Set the signaling parameters. This includes {@link MediaConstraints} for
    ...
    public void transmit(String userId, JsonObject message){
        JsonObject usrMsgJson = new JsonObject();
            usrMsgJson.add(PnRTCMessage.JSON_USERMSG, message);
